...
tortoiseimg = pygame.image.load("pic/1.png")  # 乌龟
conchimg = pygame.image.load("pic/1.png")  # 海螺
crabimg = pygame.image.load("pic/1.png")  # 螃蟹
fishimg = pygame.image.load("pic/1.png")  # 小鱼
animalimgs = [catimg, pipishrimpimg, tortoiseimg, conchimg, crabimg, fishimg]

healthbar = pygame.image.load("pic/1.png")  # 健康值横条
healthimg = pygame.image.load("pic/1.png")
